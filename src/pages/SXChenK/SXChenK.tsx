...
const InsertionSort: React.FC = () => {
  ...
  const insertionSort = useCallback((arr: number[]): Step[] => {
    let steps: Step[] = [];
    let sortedArr = [...arr];
    ...
    for (let i = 1; i < sortedArr.length; i++) {
      ...
      while (j >= 0 && (isAscending ? sortedArr[j] > value : sortedArr[j] < value)) {
        ...
        >
          ...
          <div className="flex mb-4 items-center relative h-20">
            ...
            <div
              ...
              ${currentStepData.value !== null ? "bg-yellow-300" : "bg-white border-2 border-dashed border-gray-300"}
              `}
              style={{ 
                left: `3rem`,
                top: '0',
                ...
                ${
                  currentStepData.animatingIndices?.from === index
                    ? currentStepData.animatingIndices.to === null
                      ...
                      : `translate-x-[${(currentStepData.animatingIndices.to - index) * 3.5}rem] opacity-0` // Animation di chuyển ngang
                    : currentStepData.animatingIndices?.from === -1 && currentStepData.animatingIndices?.to === index
          ...
          {currentStepData.j >= 0 && currentStepData.value !== null && !currentStepData.animatingIndices && (
            <div className="flex items-center my-4 bg-gray-50 p-4 rounded-lg shadow-sm">
              ...
              <div className="flex items-center">
                ...
                <div className="mx-4 text-2xl font-bold text-gray-600">
                  {(currentStepData.array[currentStepData.j] ?? 0) > (currentStepData.value ?? 0)
                    ? ">"
                    : "≤"}
                </div>
                <div
